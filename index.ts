...
function renderReview(review) {
    return `
        <div id="review-${review['id']}" class="card col col-6 mb-2">
            <div class="card-header">
                <h1>${review['subject']}
                    <div class="float-end fs-4">
                        <button class="btn btn-danger me-2" data-bs-toggle="modal" data-bs-target="#delete-review-modal-${review['id']}">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-review-${review['id']}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16"><path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z"/><path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z"/></svg>
                        </button>
                    </div>
                </h1>
                <hr>
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <hr>
                            <p style="white-space: pre-line;">${review['resources']}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal fade" id="delete-review-modal-${review['id']}" tabindex="-1" aria-labelledby="delete-review-modal-label-${review['id']}" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="delete-review-modal-label-${review['id']}">Are you sure you want to delete this review?</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-footer">
                            <button id="delete-review-modal-close-btn-${review['id']}" type="button" class="btn btn-primary col" data-bs-dismiss="modal">Close</button>
                            <button id="delete-review-modal-submit-btn-${review['id']}" type="button" onclick="deleteReview(${review['id']})" class="btn btn-danger col">Delete review</button>
                        </div>
                    </div>
                </div>
            </div>
...
function deleteReview(id: number) {
    ...
    document.getElementById("delete-review-modal-close-btn-" + id).click();
